	...
	<div class="container-fluid">
		...
		<div class="navbar-collapse collapse">
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a href="${tenantPrefix}/msg/msg-info-listReceived.do"> <i class="glyphicon glyphicon-bell"></i> <i id="unreadMsg" class="badge"></i>
				</a></li>
				<li><button class="btn btn-default btn-sm navbar-btn" onclick="insertWidget()">
