...
<body>
										...
										<tbody>
											<c:forEach items="${personalTasks.result}" var="item">
												<tr>
													...
													<td><a href="${tenantPrefix}/operation/task-operation-viewTaskForm.do?humanTaskId=${item.id}" class="btn btn-xs btn-primary">处理</a></td>
												</tr>
											</c:forEach>
										</tbody>
									</table>
				...
				<div class="modal-body">
					<form id="widgetForm" action="save.do" method="post">
						...
						<div class="form-group">
							<label for="portalWidgetId">组件</label> <select id="portalWidgetId" class="form-control" name="portalWidgetId">
						...
						<div class="form-group">
							<label for="portalItemName">标题</label> <input id="portalItemName" class="form-control" type="text" value="" name="portalItemName">
						</div>
					</form>
				</div>
	...
	<div class="text-center">&copy;mossle</div>
</body>
</html>