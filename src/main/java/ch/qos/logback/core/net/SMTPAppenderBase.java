...
public abstract class SMTPAppenderBase<E> extends AppenderBase<E> {
	...
	/**
	 * return a layout for the subject string as appropriate for the module. If
	 * the subjectStr parameter is null, then a default value for subjectStr
	 * should be used.
	 * 
	 * @param subjectStr
	...
	/**
	 * Perform SMTPAppender specific appending actions, delegating some of them
	 * to a subclass and checking if the event triggers an e-mail to be sent.
	 */
	...
	protected void sendBuffer(CyclicBuffer<E> cb, E lastEventObject) {
		...
		try {
			...
			Transport transport = session.getTransport(session.getProperty("mail.transport.protocol"));
	...
	/**
	 * Set the "mail.smtp.localhost" property to the value passed as parameter
	 * to this method.
	 * <p/>
	 * <p>
	 * Useful in case the hostname for the client host is not fully qualified
	 * and as a consequence the SMTP server rejects the clients HELO/EHLO
	 * command.
	 * </p>
	 * 
	 * @param localhost
	 ...
	 * name of the class implementing the {@link EventEvaluator} interface. A
	...
	/**
	 * Set the location where a {@link javax.mail.Session} resource is located
	 * in JNDI. Default value is "java:comp/env/mail/Session".
	 * 
	 * @param jndiLocation
	 * @since 1.0.6
	 */
	...
	/**
	 * If set to true, a {@link javax.mail.Session} resource will be retrieved
	 * from JNDI. Default is false.
	 * 
	...
	/**
	 * Set the character set encoding of the outgoing email messages. The
	 * default encoding is "UTF-8" which usually works well for most purposes.
	 * 
