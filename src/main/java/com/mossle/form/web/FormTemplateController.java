...
public class FormTemplateController {
	...
	public String save(@ModelAttribute FormTemplate formTemplate, @RequestParam Map<String, Object> parameterMap, RedirectAttributes redirectAttributes) {
	...
	public String remove(@RequestParam("selectedItem") List<Long> selectedItem, RedirectAttributes redirectAttributes) {
		List<FormTemplate> formTemplates = formTemplateManager.findByIds(selectedItem);
	...
	public String copy(@RequestParam("id") Long id, RedirectAttributes redirectAttributes) {
		...
		while (true) {
			FormTemplate targetFormTemplate = formTemplateManager.findUniqueBy("code", code + "" + index);
