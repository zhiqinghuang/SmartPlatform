...
public class AuthService {
	...
	public UserStatus createOrGetUserStatus(String username, String ref, String userRepoRef, String tenantId) {
		UserStatus userStatus = userStatusManager.findUnique("from UserStatus where username=? and tenantId=?", username, tenantId);
