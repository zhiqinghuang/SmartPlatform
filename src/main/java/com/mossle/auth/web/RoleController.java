...
public class RoleController {
	...
	public String save(@ModelAttribute Role role, @RequestParam("roleDefId") Long roleDefId, RedirectAttributes redirectAttributes) {
		try {
			// before check
	...
	public String viewInput(@RequestParam(value = "id", required = false) Long id, Model model) {
		if (id != null) {
			Role role = roleManager.get(id);
	...
	public String viewSave(@ModelAttribute Role role, RedirectAttributes redirectAttributes) {
		try {
			// before check
			roleChecker.check(role);
