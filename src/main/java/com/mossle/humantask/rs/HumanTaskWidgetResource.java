...
public class HumanTaskWidgetResource {
	...
	public String personalTasks() {
		...
		for (HumanTaskDTO humanTaskDto : humanTaskDtos) {
			...
			buff.append("      <td>" + dateFormat.format(humanTaskDto.getCreateTime()) + "</td>");
			buff.append("      <td>");
			buff.append("        <a href='" + ".." + "/operation/task-operation-viewTaskForm.do?humanTaskId=" + humanTaskDto.getId() + "' class='btn btn-xs btn-primary'>处理</a>");
			buff.append("      </td>");
			buff.append("    </tr>");
		}
