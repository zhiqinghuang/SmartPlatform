...
public class TaskDefinitionConnectorImpl implements TaskDefinitionConnector {
	private static Logger logger = LoggerFactory.getLogger(TaskDefinitionConnectorImpl.class);
	...
	public String findTaskAssignStrategy(String taskDefinitionKey, String processDefinitionId) {
		...
		TaskDefBase taskDefBase = taskDefBaseManager.findUnique(hql, taskDefinitionKey, processDefinitionId);
	...
	public List<String> findOperations(String taskDefinitionKey, String processDefinitionId) {
		...
		List<TaskDefOperation> taskDefOperations = taskDefOperationManager.findUnique(hql, taskDefinitionKey, processDefinitionId);
	...
	public List<TaskUserDTO> findTaskUsers(String taskDefinitionKey, String processDefinitionId) {
		...
		List<TaskDefUser> taskDefUsers = taskDefUserManager.find(hql, taskDefinitionKey, processDefinitionId);
	...
	public List<DeadlineDTO> findDeadlines(String taskDefinitionKey, String processDefinitionId) {
		...
		List<TaskDefDeadline> taskDefDeadlines = taskDefDeadlineManager.find(hql, taskDefinitionKey, processDefinitionId);
	...
	public String findTaskConfUser(String taskDefinitionKey, String businessKey) {
		...
		TaskConfUser taskConfUser = taskConfUserManager.findUnique(hql, taskDefinitionKey, businessKey);
	 ...
	 * 提醒.
	 */
	public List<TaskNotificationDTO> findTaskNotifications(String taskDefinitionKey, String processDefinitionId, String eventName) {
		String hql = "from TaskDefNotification where taskDefBase.code=? and taskDefBase.processDefinitionId=? and eventName=?";
		List<TaskDefNotification> taskDefNotifications = taskDefNotificationManager.find(hql, taskDefinitionKey, processDefinitionId, eventName);
	...
	public void create(TaskDefinitionDTO taskDefinition) {
		...
		String hql = "from TaskDefBase where code=? and processDefinitionId=?";
		TaskDefBase taskDefBase = taskDefBaseManager.findUnique(hql, taskDefinition.getCode(), taskDefinition.getProcessDefinitionId());

		if (taskDefBase == null) {
			taskDefBase = new TaskDefBase();
			taskDefBase.setCode(taskDefinition.getCode());
			taskDefBase.setProcessDefinitionId(taskDefinition.getProcessDefinitionId());
		}
	 ...
	 * 保存分配策略.
	 */
	public void saveAssignStrategy(String taskDefinitionKey, String processDefinitionId, String assignStrategy) {
		String hql = "from TaskDefBase where code=? and processDefinitionId=?";
		TaskDefBase taskDefBase = taskDefBaseManager.findUnique(hql, taskDefinitionKey, processDefinitionId);
	...
	public void addOperation(String taskDefinitionKey, String processDefinitionId, String operation) {
		...
		TaskDefOperation taskDefOperation = taskDefOperationManager.findUnique(hqlOperation, taskDefBase, operation);
	...
	public void addTaskUser(String taskDefinitionKey, String processDefinitionId, TaskUserDTO taskUser) {
		...
		TaskDefUser taskDefUser = taskDefUserManager.findUnique(hqlUser, taskDefBase, taskUser.getCatalog(), taskUser.getType(), taskUser.getValue());
	 ...
	 * 添加提醒.
	 */
	public void addTaskNotification(String taskDefinitionKey, String processDefinitionId, TaskNotificationDTO taskNotification) {
		String hql = "from TaskDefBase where code=? and processDefinitionId=?";
		TaskDefBase taskDefBase = taskDefBaseManager.findUnique(hql, taskDefinitionKey, processDefinitionId);
		...
		TaskDefNotification taskDefNotification = taskDefNotificationManager.findUnique(hqlNotification, taskDefBase, taskNotification.getEventName(), taskNotification.getTemplateCode());
	 ...
	 * 删除提醒.
	 */
	public void removeTaskNotification(String taskDefinitionKey, String processDefinitionId, TaskNotificationDTO taskNotification) {
		String hql = "from TaskDefBase where code=? and processDefinitionId=?";
		TaskDefBase taskDefBase = taskDefBaseManager.findUnique(hql, taskDefinitionKey, processDefinitionId);
	...
	public void addDeadline(String taskDefinitionKey, String processDefinitionId, DeadlineDTO deadline) {
		...
		TaskDefDeadline taskDefDeadline = taskDefDeadlineManager.findUnique(hqlDeadline, taskDefBase, deadline.getType(), deadline.getDuration());
	...
	@Resource
	public void setTaskDefOperationManager(TaskDefOperationManager taskDefOperationManager) {
	...
	@Resource
	public void setTaskDefNotificationManager(TaskDefNotificationManager taskDefNotificationManager) {
		this.taskDefNotificationManager = taskDefNotificationManager;
	}

	@Resource
	public void setTaskDefDeadlineManager(TaskDefDeadlineManager taskDefDeadlineManager) {
