...
public class AndroidFormResource {
	private static Logger logger = LoggerFactory.getLogger(AndroidFormResource.class);
	...
	public String viewStartForm(@FormParam("processDefinitionId") String processDefinitionId) throws Exception {
		...
		// required='Y' options=''/>")
		// .append("<field name='gender' label='Gender' type='choice'
		// required='Y' options='Male|Female'/>")
		// .append("<field name='age' label='Age on 15 Oct. 2010' type='numeric'
		// required='N' options=''/>")
