...
public class AndroidUserResource {
	private static Logger logger = LoggerFactory.getLogger(AndroidUserResource.class);
	...
	public BaseDTO profile(@HeaderParam("sessionId") String sessionId) throws Exception {
		logger.info("start");
