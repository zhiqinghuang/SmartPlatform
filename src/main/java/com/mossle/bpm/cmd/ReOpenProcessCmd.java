...
public class ReOpenProcessCmd implements Command<Void> {
	...
	public Void execute(CommandContext commandContext) {
		...
		ExecutionEntity processInstance = this.createProcessInstance(historicProcessInstanceEntity.getId(), businessKey, initiator, processDefinition);
	...
	public ExecutionEntity createProcessInstance(String processInstanceId, String businessKey, String authenticatedUserId, ProcessDefinitionEntity processDefinition) {
		...
		ExecutionEntity processInstance = (ExecutionEntity) this.createProcessInstance(processDefinition, processInstanceId);
