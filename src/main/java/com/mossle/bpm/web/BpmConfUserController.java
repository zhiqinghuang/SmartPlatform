...
public class BpmConfUserController {
	...
	public String list(@RequestParam("bpmConfNodeId") Long bpmConfNodeId, Model model) {
		...
		List<BpmConfUser> bpmConfUsers = bpmConfUserManager.findBy("bpmConfNode", bpmConfNode);
		BpmConfCountersign bpmConfCountersign = bpmConfCountersignManager.findUniqueBy("bpmConfNode", bpmConfNode);
		BpmConfAssign bpmConfAssign = bpmConfAssignManager.findUniqueBy("bpmConfNode", bpmConfNode);
	...
	public String remove(@RequestParam("id") Long id) {
		...
		taskUser.setValue(value);
		taskDefinitionConnector.removeTaskUser(taskDefinitionKey, processDefinitionId, taskUser);
	...
	@Resource
	public void setBpmConfCountersignManager(BpmConfCountersignManager bpmConfCountersignManager) {
		this.bpmConfCountersignManager = bpmConfCountersignManager;
	}

	@Resource
	public void setBpmConfAssignManager(BpmConfAssignManager bpmConfAssignManager) {
