...
public class BpmConfOperationController {
	...
	public String list(@RequestParam("bpmConfNodeId") Long bpmConfNodeId, Model model) {
		...
		List<BpmConfOperation> bpmConfOperations = bpmConfOperationManager.findBy("bpmConfNode", bpmConfNode);
	...
	public String save(@ModelAttribute BpmConfOperation bpmConfOperation, @RequestParam("bpmConfNodeId") Long bpmConfNodeId) {
		...
		taskDefinitionConnector.addOperation(taskDefinitionKey, processDefinitionId, operation);
	...
	public String remove(@RequestParam("id") Long id) {
		...
		String processDefinitionId = dest.getBpmConfNode().getBpmConfBase().getProcessDefinitionId();
		String operation = dest.getValue();
		taskDefinitionConnector.removeOperation(taskDefinitionKey, processDefinitionId, operation);
	...
	@Resource
	public void setBpmConfOperationManager(BpmConfOperationManager bpmConfOperationManager) {
