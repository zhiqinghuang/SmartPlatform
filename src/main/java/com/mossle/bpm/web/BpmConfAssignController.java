...
public class BpmConfAssignController {
	...
	public String save(@ModelAttribute BpmConfAssign bpmConfAssign, @RequestParam("bpmConfNodeId") Long bpmConfNodeId) {
		...
		taskDefinitionConnector.saveAssignStrategy(taskDefinitionKey, processDefinitionId, assignStrategy);
