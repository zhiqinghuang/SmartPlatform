...
public class BpmTaskDefNoticeController {
	...
	public String save(@ModelAttribute BpmTaskDefNotice bpmTaskDefNotice, @RequestParam("bpmProcessId") Long bpmProcessId, @RequestParam("bpmMailTemplateId") Long bpmMailTemplateId, RedirectAttributes redirectAttributes) {
	...
	public String remove(@RequestParam("selectedItem") List<Long> selectedItem, @RequestParam("bpmProcessId") Long bpmProcessId, RedirectAttributes redirectAttributes) {
	...
	public void export(@ModelAttribute Page page, @RequestParam Map<String, Object> parameterMap, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		List<BpmTaskDefNotice> bpmCategories = (List<BpmTaskDefNotice>) page.getResult();
	...
	// ~ ======================================================================
	@Resource
	public void setBpmTaskDefNoticeManager(BpmTaskDefNoticeManager bpmTaskDefNoticeManager) {
