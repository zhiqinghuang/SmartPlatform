...
public class BpmMailTemplateController {
	...
	public String save(@ModelAttribute BpmMailTemplate bpmMailTemplate, RedirectAttributes redirectAttributes) {
	...
	public String remove(@RequestParam("selectedItem") List<Long> selectedItem, RedirectAttributes redirectAttributes) {
		List<BpmMailTemplate> bpmCategories = bpmMailTemplateManager.findByIds(selectedItem);
