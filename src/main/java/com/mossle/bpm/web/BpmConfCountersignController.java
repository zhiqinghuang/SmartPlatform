...
public class BpmConfCountersignController {
	...
	public String save(@ModelAttribute BpmConfCountersign bpmConfCountersign, @RequestParam("bpmConfNodeId") Long bpmConfNodeId) {
		BpmConfCountersign dest = bpmConfCountersignManager.get(bpmConfCountersign.getId());
		...
		taskDefinitionConnector.saveCounterSign(taskDefinitionKey, processDefinitionId, counterSign);
