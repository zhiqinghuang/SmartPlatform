package com.mossle.internal.delegate;
...
@Component
public class DelegateModuleSpecification implements ModuleSpecification {
	private static final String MODULE_NAME = "delegate";
