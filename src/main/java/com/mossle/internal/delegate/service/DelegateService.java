...
public class DelegateService {
	...
	public DelegateInfo getDelegateInfo(String targetAssignee, String targetProcessDefinitionId, String targetTaskDefinitionKey, String tenantId) {
		String hql = "from DelegateInfo where assignee=? and status=1 and tenantId=? order by id desc";
		List<DelegateInfo> list = delegateInfoManager.find(hql, targetAssignee, tenantId);
	...
	public void addDelegateInfo(String assignee, String attorney, Date startTime, Date endTime, String processDefinitionId, String taskDefinitionKey, String tenantId) {
