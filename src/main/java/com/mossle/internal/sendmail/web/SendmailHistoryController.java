...
public class SendmailHistoryController {
	...
	public String save(@ModelAttribute SendmailHistory sendmailHistory, RedirectAttributes redirectAttributes) {
		String tenantId = tenantHolder.getTenantId();
	...
	public String remove(@RequestParam("selectedItem") List<Long> selectedItem, RedirectAttributes redirectAttributes) {
		List<SendmailHistory> sendmailHistorys = sendmailHistoryManager.findByIds(selectedItem);
	...
	public void export(@ModelAttribute Page page, @RequestParam Map<String, Object> parameterMap, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		List<SendmailHistory> sendmailHistorys = (List<SendmailHistory>) page.getResult();
