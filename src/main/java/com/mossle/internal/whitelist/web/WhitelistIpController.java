...
public class WhitelistIpController {
	...
	public String save(@ModelAttribute WhitelistIp whitelistIp, RedirectAttributes redirectAttributes) {
		String tenantId = tenantHolder.getTenantId();
	...
	public String remove(@RequestParam("selectedItem") List<Long> selectedItem, RedirectAttributes redirectAttributes) {
		List<WhitelistIp> whitelistIps = whitelistIpManager.findByIds(selectedItem);
