...
public class WhitelistService {
	private static Logger logger = LoggerFactory.getLogger(WhitelistService.class);
	...
	public void saveWhitelistApp(WhitelistApp whitelistApp, Long whitelistTypeId, String hostContent, String ipContent, String username, String tenantId) {
	...
	public void processHost(WhitelistApp whitelistApp, List<String> hosts) {
		...
		List<WhitelistHost> whitelistHosts = new ArrayList<WhitelistHost>(whitelistApp.getWhitelistHosts());
