...
public class TemplateConnectorImpl implements TemplateConnector {
	...
	public TemplateDTO findByCode(String code, String tenantId) {
		...
		Map<String, Object> templateInfoMap = jdbcTemplate.queryForMap(templateInfoSql, code, tenantId);
	...
	public List<TemplateDTO> findAll(String tenantId) {
		...
		for (Map<String, Object> templateInfoMap : jdbcTemplate.queryForList(templateInfoSql, tenantId)) {
	...
	public TemplateDTO processTemplateInfo(Map<String, Object> templateInfoMap) {
		...
		List<Map<String, Object>> templateFieldList = jdbcTemplate.queryForList(templateFieldSql, templateInfoMap.get("ID"));

		for (Map<String, Object> templateFieldMap : templateFieldList) {
			templateDto.getFields().put((String) templateFieldMap.get("name"), (String) templateFieldMap.get("content"));
		}
