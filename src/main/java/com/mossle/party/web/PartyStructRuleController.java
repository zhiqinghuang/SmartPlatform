...
public class PartyStructRuleController {
	...
	public String save(@RequestParam(value = "id", required = false) Long id, @RequestParam("partyStructTypeId") Long partyStructTypeId, @RequestParam("parentTypeId") Long parentTypeId, @RequestParam("childTypeId") Long childTypeId, RedirectAttributes redirectAttributes) {
		String tenantId = tenantHolder.getTenantId();
		...
		partyStructRule.setPartyStructType(partyStructTypeManager.get(partyStructTypeId));
	...
	public String remove(@RequestParam("selectedItem") List<Long> selectedItem, RedirectAttributes redirectAttributes) {
		partyStructRuleManager.removeAll(partyStructRuleManager.findByIds(selectedItem));
	...
	// ~ ======================================================================
	@Resource
	public void setPartyStructRuleManager(PartyStructRuleManager partyStructRuleManager) {
