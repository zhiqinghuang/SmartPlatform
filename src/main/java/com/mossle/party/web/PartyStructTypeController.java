...
public class PartyStructTypeController {
	...
	public String save(@ModelAttribute PartyStructType partyStructType, RedirectAttributes redirectAttributes) {
		String tenantId = tenantHolder.getTenantId();
	...
	public String remove(@RequestParam("selectedItem") List<Long> selectedItem, RedirectAttributes redirectAttributes) {
		partyStructTypeManager.removeAll(partyStructTypeManager.findByIds(selectedItem));
