...
public class UserCreatedSubscriber implements Subscribable<String> {
	...
	private String insertPartyEntitySql = "INSERT INTO PARTY_ENTITY(NAME,REF,TYPE_ID,TENANT_ID) VALUES(?,?,?,?)";
	...
	public void handleMessage(String message) {
		...
		try {
			...
			jdbcTemplate.update(insertPartyEntitySql, userDto.getUsername(), userDto.getId(), typeId, tenantId);
	...
	public Long findUserTypeId(String tenantId) {
		Long typeId = jdbcTemplate.queryForObject(selectUserPartyTypeSql, Long.class, PartyConstants.TYPE_USER, tenantId);
