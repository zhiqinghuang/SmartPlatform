...
public class TaskOperationController {
	private static Logger logger = LoggerFactory.getLogger(TaskOperationController.class);
	...
	public String completeTask(HttpServletRequest request, RedirectAttributes redirectAttributes) throws Exception {
		...
		try {
			humanTaskConnector.completeTask(humanTaskId, currentUserHolder.getUserId(), taskParameters);
	...
	public String rollbackPrevious(@RequestParam("humanTaskId") String humanTaskId) {
	...
	public String transfer(@RequestParam("humanTaskId") String humanTaskId, @RequestParam("userId") String userId) {
	...
	public String delegateTask(@RequestParam("humanTaskId") String humanTaskId, @RequestParam("userId") String userId) {
	...
	public String delegateTaskCreate(@RequestParam("humanTaskId") String humanTaskId, @RequestParam("userId") String userId) {
