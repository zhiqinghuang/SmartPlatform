...
public class AccountLogWorker implements Runnable {
	private static Logger logger = LoggerFactory.getLogger(AccountLogWorker.class);
	private String url;
	...
	public void run() {
		...
		buff.append("&logTime=").append(new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss.S").format(new Date()));
