...
public class AccountLogClient {
	...
	public void log(String application, String result, String reason, String username, String client, String description) {
		try {
	...
	public void log(String result, String reason) {
		try {
			...
			this.log(accountLogDto.getApplication(), result, reason, accountLogDto.getUsername(), accountLogDto.getClient(), accountLogDto.getDescription());
		} catch (Exception ex) {
			ex.printStackTrace();
		}
	}
