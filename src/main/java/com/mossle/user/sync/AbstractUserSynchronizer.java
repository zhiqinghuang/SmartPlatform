...
public abstract class AbstractUserSynchronizer {
	...
	public abstract void doSync(List<UserSyncDTO> removes, List<UserSyncDTO> inserts, List<UserSyncDTO> updates);

	public void execute() {
		List<UserSyncDTO> localUsers = this.getLocalUsers();
		List<UserSyncDTO> remoteUsers = this.getRemoteUsers();

		Map<String, UserSyncDTO> localUserMap = this.convertListToMap(localUsers);
		Map<String, UserSyncDTO> remoteUserMap = this.convertListToMap(remoteUsers);
	...
	public Map<String, UserSyncDTO> convertListToMap(List<UserSyncDTO> userSyncDtos) {
