...
public class PartyUserNotification implements UserNotification {
	private static Logger logger = LoggerFactory.getLogger(PartyUserNotification.class);
	...
	public void updateUser(UserBase userBase) {
		Long typeId = 1L;
		jdbcTemplate.update(updatePartyEntitySql, userBase.getUsername(), userBase.getId(), typeId);
	}
