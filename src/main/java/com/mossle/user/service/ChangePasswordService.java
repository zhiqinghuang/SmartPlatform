...
public class ChangePasswordService {
	...
	public ChangePasswordResult changePassword(String username, String oldPassword, String newPassword, String confirmPassword) {
		...
		return this.changePassword(accountInfo, oldPassword, newPassword, confirmPassword);
	}

	public ChangePasswordResult changePassword(Long accountId, String oldPassword, String newPassword, String confirmPassword) {
		ChangePasswordResult changePasswordResult = new ChangePasswordResult();
	...
	public ChangePasswordResult changePassword(AccountInfo accountInfo, String oldPassword, String newPassword, String confirmPassword) {
		ChangePasswordResult changePasswordResult = new ChangePasswordResult();
