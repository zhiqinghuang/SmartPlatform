...
public class UserService {
	...
	public void insertUser(UserBase userBase, Long userRepoId, Map<String, Object> parameters) {
		...
		for (Map.Entry<String, Object> entry : parameters.entrySet()) {
			...
			UserSchema userSchema = userSchemaManager.findUnique("from UserSchema where code=? and userRepo.id=?", key, userRepoId);
	...
	public void updateUser(UserBase userBase, Long userRepoId, Map<String, Object> parameters) {
		...
		for (Map.Entry<String, Object> entry : parameters.entrySet()) {
			...
			UserAttr userAttr = userAttrManager.findUnique("from UserAttr where userSchema=? and userBase=?", userSchema, userBase);
