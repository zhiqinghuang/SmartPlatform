...
public class UserResource {
	...
	@Path("search")
	@Produces(MediaType.APPLICATION_JSON)
	public List<Map<String, Object>> search(@QueryParam("username") String username) {
		List<AccountInfo> accountInfos = accountInfoManager.find("from AccountInfo where username like ?", "%" + username + "%");
