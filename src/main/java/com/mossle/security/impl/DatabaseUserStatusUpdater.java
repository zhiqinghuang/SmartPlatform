...
public class DatabaseUserStatusUpdater implements UserStatusUpdater {
	private static Logger logger = LoggerFactory.getLogger(DatabaseUserStatusUpdater.class);
	...
	public void updateUser(String username, int status) {
		int count = jdbcTemplate.queryForObject(selectSql, Integer.class, username);
