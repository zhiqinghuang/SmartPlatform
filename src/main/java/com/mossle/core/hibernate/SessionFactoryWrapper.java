...
public class SessionFactoryWrapper implements SessionFactoryImplementor {
	...
	public void setSessionFactory(SessionFactory sessionFactory) {
		if (sessionFactory instanceof SessionFactoryImplementor) {
			...
			throw new IllegalStateException("the type of sessionFactory[" + sessionFactory + "] is not SessionFactoryImplementor");
		}
	}
	...
	/**
	 * 此处需要进行封装，如果sessionFactory没有构建成功，就自己新建. 否则应该使用
	 * <code>sessionFactory.getStatistics()</code>
	 */
