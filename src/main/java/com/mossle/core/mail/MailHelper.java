...
public class MailHelper {
	...
	public MailDTO send(String from, String to, String subject, String content) {
		return this.send(from, to, subject, content, this.getDefaultMailServerInfo());
	}

	public MailDTO send(String from, String to, String subject, String content, String mailServerInfoName) {
		return this.send(from, to, subject, content, mailServerInfoCache.getMailServerInfo(mailServerInfoName));
	}

	public MailDTO send(String from, String to, String subject, String content, MailServerInfo mailServerInfo) {
	...
	protected MailDTO sendTestMail(MailDTO mailDto, MailServerInfo mailServerInfo) {
		String from = mailDto.getFrom();
		String to = mailDto.getTo();
		String subject = mailDto.getSubject();
		String content = mailDto.getContent();
