...
public class FileStoreHelper implements StoreHelper {
	...
	public StoreResult saveStore(String model, DataSource dataSource) throws Exception {
	...
	public StoreResult saveStore(String model, String key, DataSource dataSource) throws Exception {
		String path = key;
