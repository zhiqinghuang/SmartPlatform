...
public class ReflectUtils {
	...
	public static void setMethodValue(Object target, String methodName, Object methodValue) throws NoSuchMethodException, IllegalAccessException, InvocationTargetException {
	...
	public static Object getFieldValue(Object target, String fieldName, boolean isForce) throws NoSuchFieldException, IllegalAccessException {
	...
	public static RuntimeException convertReflectionExceptionToUnchecked(Exception e) {
		if (e instanceof RuntimeException) {
		...
		} else if (e instanceof IllegalAccessException || e instanceof NoSuchMethodException || e instanceof NoSuchFieldException) {
			...
			if (targetException instanceof RuntimeException) {
				...
				return new RuntimeException("Reflection Exception.", targetException);
			}
		}
