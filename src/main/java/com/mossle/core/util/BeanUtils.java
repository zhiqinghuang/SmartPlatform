...
public class BeanUtils /* extends org.apache.commons.beanutils.BeanUtils */ {
	 ...
	 *             如果没有该Field时抛出.
	 */
	public static void forceSetProperty(Object object, String propertyName, Object newValue) throws NoSuchFieldException, IllegalAccessException {
	...
	public static void safeSetFieldValue(Object object, String fieldName, Object newValue, boolean targetAccessible) {
		try {
	...
	public static Object invokeMethod(Object object, String methodName, Object... params) throws NoSuchMethodException, IllegalAccessException, InvocationTargetException {
		return invokeMethod(object, methodName, false, params);
	}

	public static Object invokeMethod(Object object, String methodName, boolean targetAccessible, Object... params) throws NoSuchMethodException, IllegalAccessException, InvocationTargetException {
		Assert.notNull(object);
		...
		if (method == null) {
			throw new NoSuchMethodException("No Such Method : " + clazz.getSimpleName() + "." + methodName + Arrays.asList(types));
		}
	 ...
	 *             field不存在时抛出异常
	 * 
	 * @todo: 使用reflectUtils里的方法更合适，这里的实现方式，必须先有field才能有method，逻辑上有问题
	 *        实际上，即使没有field也可以单独有method。
	 */
