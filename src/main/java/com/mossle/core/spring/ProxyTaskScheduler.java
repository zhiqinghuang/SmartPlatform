...
public class ProxyTaskScheduler implements TaskScheduler, InitializingBean, DisposableBean {
	private static Logger logger = LoggerFactory.getLogger(ProxyTaskScheduler.class);
