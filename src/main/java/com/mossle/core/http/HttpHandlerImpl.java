...
public class HttpHandlerImpl implements HttpHandler {
	...
	public String readText(String url, Map<String, Object> parameterMap) throws IOException {
		return readText(url, "UTF-8", parameterMap);
	}

	public String readText(String url, String encoding, Map<String, Object> parameterMap) throws IOException {
		...
		HttpURLConnection conn = (HttpURLConnection) new URL(buff.toString()).openConnection();
