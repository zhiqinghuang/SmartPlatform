...
public class HttpConnectionInfo {
	private static Logger logger = LoggerFactory.getLogger(HttpConnectionInfo.class);
	...
	public HttpConnectionResult process(String method, Map<String, String> queryParams, Map<String, String> formParams, Map<String, String> headParams) {
	...
	private boolean notContains(String buff, String key) {
		return (buff.indexOf("?" + key + "=") == -1) && (buff.indexOf("&" + key + "=") == -1);
	}

	private void appendHeadParams(HttpURLConnection conn, Map<String, String> headParams) {
