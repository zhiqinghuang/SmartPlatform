...
public class MeetingRoomController {
	...
	public String save(@ModelAttribute MeetingRoom meetingRoom, @RequestParam Map<String, Object> parameterMap, RedirectAttributes redirectAttributes) {
		String tenantId = tenantHolder.getTenantId();
	...
	public String remove(@RequestParam("selectedItem") List<Long> selectedItem, RedirectAttributes redirectAttributes) {
		List<MeetingRoom> meetingRooms = meetingRoomManager.findByIds(selectedItem);
