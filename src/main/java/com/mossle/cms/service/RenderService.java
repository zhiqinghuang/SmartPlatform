...
public class RenderService {
	...
	public void renderDetail(CmsArticle cmsArticle) {
		try {
			...
			String html = templateService.render(cmsCatalog.getTemplateDetail(), data);
	...
	public void renderIndex(CmsCatalog cmsCatalog) {
		try {
			...
			String html = templateService.render(cmsCatalog.getTemplateIndex(), data);
	...
	public String viewCatalog(CmsCatalog cmsCatalog) {
		...
		String html = templateService.render(cmsCatalog.getTemplateList(), data);
