...
public class CmsFavoriteController {
	...
	public String save(@ModelAttribute CmsFavorite cmsFavorite, RedirectAttributes redirectAttributes) {
	...
	public String remove(@RequestParam("selectedItem") List<Long> selectedItem, RedirectAttributes redirectAttributes) {
		List<CmsFavorite> cmsFavorites = cmsFavoriteManager.findByIds(selectedItem);
