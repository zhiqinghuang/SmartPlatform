...
public class CmsWidgetResource {
	private static Logger logger = LoggerFactory.getLogger(CmsWidgetResource.class);
	...
	public String articles() throws Exception {
		...
		for (CmsArticle cmsArticle : cmsArticles) {
			buff.append("<div>");
			buff.append("  <h4><a href='../cms/cms-article-view.do?id=" + cmsArticle.getId() + "'>" + cmsArticle.getTitle() + "</h4>");
