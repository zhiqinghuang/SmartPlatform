...
public class ArticleExporter {
	public void doExport(File baseDir, JdbcTemplate jdbcTemplate, String articleId) throws Exception {
		try {
	...
	public void exportProperties(File baseDir, Map<String, Object> map) throws Exception {
	...
	public void exportContent(File baseDir, Map<String, Object> map) throws Exception {
		String code = (String) map.get("code");
