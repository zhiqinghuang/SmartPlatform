...
public class CatalogExporter {
	public void doExport(File baseDir, JdbcTemplate jdbcTemplate, String catalogId) throws Exception {
		File dir = this.exportCatalog(baseDir, jdbcTemplate, catalogId);

		this.exportArticles(dir, jdbcTemplate, catalogId);
	}

	public File exportCatalog(File baseDir, JdbcTemplate jdbcTemplate, String catalogId) throws Exception {
	...
	public void exportArticles(File dir, JdbcTemplate jdbcTemplate, String catalogId) throws Exception {
		String sql = "select id from CMS_ARTICLE where CATALOG_ID=?";
		List<Map<String, Object>> list = jdbcTemplate.queryForList(sql, catalogId);
