...
public class PimFavoriteController {
	...
	public String save(@ModelAttribute PimFavorite pimFavorite, RedirectAttributes redirectAttributes) {
		String userId = currentUserHolder.getUserId();
	...
	public String remove(@RequestParam("selectedItem") List<Long> selectedItem, RedirectAttributes redirectAttributes) {
		List<PimFavorite> pimFavorites = pimFavoriteManager.findByIds(selectedItem);
