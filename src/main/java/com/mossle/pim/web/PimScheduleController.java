...
public class PimScheduleController {
	...
	public String save(@ModelAttribute PimSchedule pimSchedule, @RequestParam Map<String, Object> parameterMap, RedirectAttributes redirectAttributes) {
	...
	public String remove(@RequestParam("selectedItem") List<Long> selectedItem, RedirectAttributes redirectAttributes) {
		List<PimSchedule> pimSchedules = pimScheduleManager.findByIds(selectedItem);
