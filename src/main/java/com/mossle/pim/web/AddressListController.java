...
public class AddressListController {
	...
	public String list(@RequestParam(value = "username", required = false) String username, Model model) {
		...
		String sql = "select ai.id as id,ai.username as username,ai.display_name as displayName,pi.email as email,pi.cellphone as mobile" + " from ACCOUNT_INFO ai left join PERSON_INFO pi on ai.code=pi.code" + " where ai.tenant_ID=? and ai.username like ?";
