...
public class ScheduleResource {
	...
	public BaseDTO save(@FormParam("title") String title, @FormParam("start") Date start, @FormParam("end") Date end, @FormParam("content") String content) {
		try {
	...
	@Path("update")
	@Produces(MediaType.APPLICATION_JSON)
	public BaseDTO update(@FormParam("id") Long id, @FormParam("title") String title, @FormParam("start") Date start, @FormParam("end") Date end, @FormParam("content") String content) {
		try {
	...
	public BaseDTO get() {
		try {
			...
			List<PimSchedule> pimSchedules = pimScheduleManager.findBy("userId", userId);
