...
public class ProxyConnection implements Connection {
	...
	public void sendMessage(Destination destination, Message message) throws JMSException {
		this.proxyConnectionFactory.sendMessage(messageContext, destination, message);
	}

	public Message getMessage(ProxyMessageConsumer proxyMessageConsumer) throws JMSException {
		return this.proxyConnectionFactory.getMessage(messageContext, proxyMessageConsumer);
	}
	...
	public MessageProducer createProducer(Destination destination, ProxySession session) throws JMSException {
