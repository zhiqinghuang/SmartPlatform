...
public class MemoryMessageHandler extends DefaultMessageHandler {
	...
	public void sendMessageToQueue(MessageContext messageContext, String name, Message message) {
	...
	public void sendMessageToTopic(MessageContext messageContext, String name, Message message) {
	...
	public Message consumeMessageFromQueue(MessageContext messageContext, String name) {
		List<Message> list = queueMessages.get(name);
	...
	public Message consumeMessageFromTopic(MessageContext messageContext, String name, String consumerName) {
		Map<String, List<Message>> consumerMap = topicMessages.get(name);
